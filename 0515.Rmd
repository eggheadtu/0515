...
並在1955年上畫上一條黑色虛線。 
    ...
    p=ggplot(polio.sumYear, aes(YEAR, variable)) + geom_tile(aes(fill = polio.sumYear$value),colour = "white") + scale_fill_gradient(name="發生率", low = "white",high = "Blue")+ geom_vline(xintercept = 1955,colour= "black",linetype = "longdash" ) 
    print(p) 
